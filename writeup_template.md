...
1- in case of traffic sign classifier the color has no effect on sing type, like the numbers classifier the color has no effect on number class, color one is the same as gray scale one
...
The model was able to correctly guess 4 of the 5 traffic signs, which gives an accuracy of 81%. This compares favorably to the accuracy on the test set of ...
